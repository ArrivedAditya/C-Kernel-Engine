...
class NumericalExecutionContractTests(unittest.TestCase):
    ...
    def test_kernel_interface_migration_debt_does_not_regress(self):
        ...
        self.assertEqual(report["counts"]["kernel_maps"], 279)
        self.assertEqual(report["counts"]["physical_layout_maps"], 2)
        ...
        self.assertEqual(report["counts"]["selection_managed_maps"], 40)
