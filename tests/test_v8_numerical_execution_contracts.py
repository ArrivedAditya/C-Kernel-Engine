...
class NumericalExecutionContractTests(unittest.TestCase):
    ...
    def test_kernel_interface_migration_debt_does_not_regress(self):
        ...
        self.assertEqual(report["counts"]["kernel_maps"], 280)
        self.assertEqual(report["counts"]["physical_layout_maps"], 3)
        ...
        self.assertEqual(report["counts"]["map_owned_call_abi"], 131)
        self.assertEqual(report["counts"]["legacy_interface_ready_maps"], 25)
        self.assertEqual(report["counts"]["selection_managed_maps"], 43)
