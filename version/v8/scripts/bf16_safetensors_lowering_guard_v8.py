...
def run_guard(workdir: Path) -> None:
    ...
    expected_kernels = {
        ...
        "mlp_down": "gemm_nt_bf16_pytorch_onednn_brgemm_bf16_storage",
        "projector_fc1": "gemm_nt_bf16_pytorch_onednn_brgemm_bf16_storage",
        "projector_fc2": "gemm_nt_bf16_pytorch_onednn_brgemm_bf16_storage",
    }
