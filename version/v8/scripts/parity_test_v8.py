...
"""
parity_test_v8.py - Layer-by-layer parity comparison between llama.cpp and CKE
...
Usage:
    ...
    python version/v8/scripts/parity_test_v8.py --ck-dump ck_parity_dumps/dump.bin

    # Compare both runtimes
    python version/v8/scripts/parity_test_v8.py --gguf model.gguf --tokens 1

    # With tolerance
    python version/v8/scripts/parity_test_v8.py --ck-dump ck_parity_dumps/dump.bin --atol 1e-3

    # Family + pass filter compatibility (used by higher-level tooling)
    python version/v8/scripts/parity_test_v8.py --ck-dump ck_parity_dumps/dump.bin --model qwen3 --pass prefill
"""
...
Examples:
    ...
    python version/v8/scripts/parity_test_v8.py \\
