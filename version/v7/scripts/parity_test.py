...
Usage:
    ...
    python version/v7/scripts/parity_test.py --ck-dump ck_parity_dumps/dump.bin

    # Compare both runtimes
    python version/v7/scripts/parity_test.py --gguf model.gguf --tokens 1

    # With tolerance
    python version/v7/scripts/parity_test.py --ck-dump ck_parity_dumps/dump.bin --atol 1e-3

    # Family + pass filter compatibility (used by higher-level tooling)
    python version/v7/scripts/parity_test.py --ck-dump ck_parity_dumps/dump.bin --model qwen3 --pass prefill
"""
...
Examples:
    ...
    python version/v7/scripts/parity_test.py \\
