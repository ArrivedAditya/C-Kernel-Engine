...
from ck_run_v7 import CACHE_DIR, detect_input_type
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Resolve model dir for v7 input")
    parser.add_argument("--model-input", required=True, help="Same model input accepted by ck_run_v7.py")
