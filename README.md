...
![C-Kernel-Engine cover](docs/site/assets/cover_image.png)
...
![CKE at a glance: one compiler turns GGUF and SafeTensors models into readable generated C runtimes across text, vision, and audio, with measured numerical evidence and per-op X-Ray introspection](docs/site/assets/cke-overview.svg)

![C-Kernel-Engine capability map](docs/site/assets/cke-capability-map.png)
