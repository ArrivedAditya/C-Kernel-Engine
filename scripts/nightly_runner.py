...
TEST_SUITES = {
    ...
    "yarn_rope_explicit_positions": TestSuite("YaRN RoPE Position Providers", "kernels", UNITTEST_DIR / "test_instella_yarn_rope.py"),
    ...
    "yarn_rope_explicit_positions_bf16": TestSuite("YaRN RoPE Position Providers BF16", "bf16", UNITTEST_DIR / "test_instella_yarn_rope.py"),
