...
TEST_SUITES = {
    ...
    "yarn_rope_explicit_positions": TestSuite("YaRN RoPE Explicit Positions", "kernels", UNITTEST_DIR / "test_instella_yarn_rope.py"),
    ...
    "yarn_rope_explicit_positions_bf16": TestSuite("YaRN RoPE Explicit Positions BF16", "bf16", UNITTEST_DIR / "test_instella_yarn_rope.py"),
...
MAKE_TARGETS = {
    ...
    "v7_ir_visualizer_e2e": {
        "name": "v7 IR Visualizer E2E (nightly)",
        "category": "parity",
